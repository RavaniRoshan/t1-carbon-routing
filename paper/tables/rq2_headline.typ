...
#academic-table([Headline results (Azure 40k).],
  (
    ...
    [Round-robin], [0.0121 [0.0121, 0.0121]], [0.57%], [117.7], [\<0.001],
    [Least-RTT], [0.0205 [0.0205, 0.0205]], [95.07%], [15258.6], [\<0.001],
    [Latency-only], [0.0167 [0.0166, 0.0169]], [0.13%], [106.0], [\<0.001],
    [C-blind SLO], [0.0167 [0.0166, 0.0169]], [0.13%], [106.0], [\<0.001]
  ),
